...
let args = message.content.split(" ").slice(1);
let msg = args.join(' ');
let dev = client.users.get("3490404894071717930"); //Your id
...
let Room = client.channels.get('588438452513669144');
 
if(message.content.startsWith(prefix + "رفض")) {
 
if(message.guild.id !== '588355466946674689') return;
...
client.on("ready", () => {
  ...
  client.channels.get("588440159498928129").setName(`~ she3a YT Subs : ${data.subscribers}`)
  })
